...
# Wallet / Add-money
# ---------------------------------------------------------------------------
ADD_MONEY_MAX_AMOUNT: int = _rules["wallet"]["add_money_max_amount"]
...
TRANSFER_MIN_AMOUNT: int = _rules["transfer"]["min_amount"]

# ---------------------------------------------------------------------------
# Loans
# ---------------------------------------------------------------------------
LOAN_INTEREST_RATE_PA: float = _rules["loan"]["interest_rate_pa"]
...
# Account on-boarding
# ---------------------------------------------------------------------------
JOINING_BONUS_AMOUNT: int = _rules["account"]["joining_bonus_amount"]
SALARY_CREDIT_DELAY_SECONDS: int = _rules["account"]["salary_credit_delay_seconds"]
DEFAULT_ACCOUNT_TYPE: str = _rules["account"]["default_type"]
